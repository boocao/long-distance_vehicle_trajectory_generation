...
if __name__=='__main__':
    # txt_path ='./outputs/output_downsampling.txt'
    # txt_path ='./reconstruction_txts/exp0502_reconstructed.txt'
    txt_path ='F:/AerialVideos/04Trajectory/exp5/output_reconstructed.txt'
    # txt_path ='E:/07Experiment-data/VideoSets/03AerialVideos-LongTrajectoryFiles/exp0502/exp5/output.txt'
    data = np.loadtxt(txt_path, delimiter=',',dtype=bytes).astype(str)
    data = data.astype(np.float64)

    # data = data[data[:,0]==1671,:]
