...
if __name__=='__main__':
    det1_path = 'output1.txt'
    det2_path = 'output2.txt'
    ...
    X1,Y1,delta_pixel=3840-252,72,400  ## 拼接点X1,Y1=3840-252,728;和右边视频留存的像素量delta=400
    ...
    data_fusion1=data_fusion1[data_fusion1[:,-2]<=X1+10,:]
    data_fusion2=data_fusion2[data_fusion2[:,-2]>=X1-10,:]
    data_fusion=np.concatenate([data_fusion1,data_fusion2],axis=0)
    data_fusion=data_fusion[data_fusion[:, 0] <= 18600, :]
